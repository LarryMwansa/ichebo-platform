...
urlpatterns = [
    ...
    path('learn/induction/', views.induction_track, name='induction_track'),
    path('learn/induction/lesson/<uuid:step_id>/', views.induction_lesson, name='induction_lesson'),
    ...
    path('steward/settings/htmx/appearance/', views.htmx_steward_settings_appearance, name='htmx_steward_settings_appearance'),
