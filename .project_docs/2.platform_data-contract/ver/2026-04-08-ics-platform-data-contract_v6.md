...
> **Previous version:** v5 — 2026-04-08
>
...
5.1 Bible App — system design complete (`2026-04-08-ics-bible-app-system-design_v1.md`)
...
BibleTranslation {
  ...
  is_public:  boolean                 # False = licensed, restricted
  created_at: datetime
}

BibleBook {
  id:        integer (auto PK)
  code:      string, unique           # 'GEN', 'MAT', 'REV'
  name:      string                   # 'Genesis'
  testament: 'OT' | 'NT'
  order:     integer, unique          # 1–66 canonical order
}
# BibleBook is translation-independent. 66 rows. Loaded once.
...
# ~31,191 verses per translation. ~93,573 rows at setup (3 translations).
```

### 13.2 Translations loaded at setup

| Code | Name                  | Language | Default | Source                              |
|------|-----------------------|----------|---------|-------------------------------------|
| KJV  | King James Version    | en       | Yes     | thiagobodruk/bible (GitHub)         |
| ASV  | American Standard Version | en   | No      | christos-c/bible-api (GitHub)       |
| WEB  | World English Bible   | en       | No      | scrollmapper/bible_databases (GitHub) |

All three are public domain. Licensed translations (NIV, ESV, NLT) require
publisher agreements — deferred post-MVP.
